...
from openapiclient.models.pkg_cpe_add_cpe_response_body import PkgCpeAddCpeResponseBody  # noqa: E501
...
class TestPkgCpeAddCpeResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `PkgCpeAddCpeResponseBody`
        """
        model = openapiclient.models.pkg_cpe_add_cpe_response_body.PkgCpeAddCpeResponseBody()  # noqa: E501
        if include_optional :
