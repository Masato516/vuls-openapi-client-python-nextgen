...
from openapiclient.models.pkg_cpe_get_cpe_detail_response_body import PkgCpeGetCpeDetailResponseBody  # noqa: E501
...
class TestPkgCpeGetCpeDetailResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `PkgCpeGetCpeDetailResponseBody`
        """
        model = openapiclient.models.pkg_cpe_get_cpe_detail_response_body.PkgCpeGetCpeDetailResponseBody()  # noqa: E501
        if include_optional :
