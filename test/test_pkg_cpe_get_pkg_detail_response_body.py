...
from openapiclient.models.pkg_cpe_get_pkg_detail_response_body import PkgCpeGetPkgDetailResponseBody  # noqa: E501
...
class TestPkgCpeGetPkgDetailResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `PkgCpeGetPkgDetailResponseBody`
        """
        model = openapiclient.models.pkg_cpe_get_pkg_detail_response_body.PkgCpeGetPkgDetailResponseBody()  # noqa: E501
        if include_optional :
