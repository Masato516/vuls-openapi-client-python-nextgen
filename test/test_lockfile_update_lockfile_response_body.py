...
from openapiclient.models.lockfile_update_lockfile_response_body import LockfileUpdateLockfileResponseBody  # noqa: E501
...
class TestLockfileUpdateLockfileResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `LockfileUpdateLockfileResponseBody`
        """
        model = openapiclient.models.lockfile_update_lockfile_response_body.LockfileUpdateLockfileResponseBody()  # noqa: E501
        if include_optional :
