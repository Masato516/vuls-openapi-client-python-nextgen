...
class ServerGetServerDetailResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerGetServerDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerGetServerDetailResponseBody:
        """Create an instance of ServerGetServerDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerGetServerDetailResponseBody.parse_obj(obj)

        _obj = ServerGetServerDetailResponseBody.parse_obj({
