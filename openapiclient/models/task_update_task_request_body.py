...
class TaskUpdateTaskRequestBody(BaseModel):
    ...
    def priority_validate_enum(cls, v):
        ...
        if v not in ('none', 'high', 'medium', 'low'):
            raise ValueError("must be one of enum values ('none', 'high', 'medium', 'low')")
        return v
    ...
    def status_validate_enum(cls, v):
        ...
        if v not in ('new', 'investigating', 'ongoing', 'defer', 'not_affected', 'risk_accepted', 'workaround'):
            raise ValueError("must be one of enum values ('new', 'investigating', 'ongoing', 'defer', 'not_affected', 'risk_accepted', 'workaround')")
        return v
