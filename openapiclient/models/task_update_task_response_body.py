...
class TaskUpdateTaskResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskUpdateTaskResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskUpdateTaskResponseBody:
        """Create an instance of TaskUpdateTaskResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TaskUpdateTaskResponseBody.parse_obj(obj)

        _obj = TaskUpdateTaskResponseBody.parse_obj({
