...
class GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody(BaseModel):
    """
    GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody
    """
    paging: Optional[PagingResponseBody] = None
    pkg_cpes: Optional[conlist(GroupSetPkgCpeListResponseBody)] = Field(None, alias="pkgCpes", description="PkgCpes list")
    __properties = ["paging", "pkgCpes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody:
        """Create an instance of GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody.parse_obj(obj)

        _obj = GroupSetPkgCpeGetGroupSetPkgCpeListResponseBody.parse_obj({
            "paging": PagingResponseBody.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "pkg_cpes": [GroupSetPkgCpeListResponseBody.from_dict(_item) for _item in obj.get("pkgCpes")] if obj.get("pkgCpes") is not None else None
        })
        return _obj
