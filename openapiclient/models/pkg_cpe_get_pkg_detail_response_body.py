...
class PkgCpeGetPkgDetailResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PkgCpeGetPkgDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PkgCpeGetPkgDetailResponseBody:
        """Create an instance of PkgCpeGetPkgDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PkgCpeGetPkgDetailResponseBody.parse_obj(obj)

        _obj = PkgCpeGetPkgDetailResponseBody.parse_obj({
