...
class CveGetCveDetailResponseBody(BaseModel):
    ...
    env_metric_v2s: conlist(EnvMetricV2ResponseBody) = Field(..., alias="envMetricV2s", description="envMetricV2 of cve")
    env_metric_v3s: conlist(EnvMetricV3ResponseBody) = Field(..., alias="envMetricV3s", description="envMetricV3 of cve")
    ...
    sec_metrics: conlist(SecMetricResponseBody) = Field(..., alias="secMetrics", description="secMetric of cve")
