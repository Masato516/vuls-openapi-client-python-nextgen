...
class LockfileUpdateLockfileResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LockfileUpdateLockfileResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LockfileUpdateLockfileResponseBody:
        """Create an instance of LockfileUpdateLockfileResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LockfileUpdateLockfileResponseBody.parse_obj(obj)

        _obj = LockfileUpdateLockfileResponseBody.parse_obj({
