...
class GroupSetServerGetGroupSetServerDetailResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetServerGetGroupSetServerDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetServerGetGroupSetServerDetailResponseBody:
        """Create an instance of GroupSetServerGetGroupSetServerDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetServerGetGroupSetServerDetailResponseBody.parse_obj(obj)

        _obj = GroupSetServerGetGroupSetServerDetailResponseBody.parse_obj({
