...
class LockfileGetLockfileDetailResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LockfileGetLockfileDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LockfileGetLockfileDetailResponseBody:
        """Create an instance of LockfileGetLockfileDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LockfileGetLockfileDetailResponseBody.parse_obj(obj)

        _obj = LockfileGetLockfileDetailResponseBody.parse_obj({
