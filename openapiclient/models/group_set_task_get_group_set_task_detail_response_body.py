...
class GroupSetTaskGetGroupSetTaskDetailResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetTaskGetGroupSetTaskDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetTaskGetGroupSetTaskDetailResponseBody:
        """Create an instance of GroupSetTaskGetGroupSetTaskDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetTaskGetGroupSetTaskDetailResponseBody.parse_obj(obj)

        _obj = GroupSetTaskGetGroupSetTaskDetailResponseBody.parse_obj({
