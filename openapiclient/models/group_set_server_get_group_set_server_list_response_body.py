...
class GroupSetServerGetGroupSetServerListResponseBody(BaseModel):
    """
    GroupSetServerGetGroupSetServerListResponseBody
    """
    paging: Optional[PagingResponseBody] = None
    servers: Optional[conlist(ServerListResponseBody)] = Field(None, description="Servers list")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetServerGetGroupSetServerListResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetServerGetGroupSetServerListResponseBody:
        """Create an instance of GroupSetServerGetGroupSetServerListResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetServerGetGroupSetServerListResponseBody.parse_obj(obj)

        _obj = GroupSetServerGetGroupSetServerListResponseBody.parse_obj({
