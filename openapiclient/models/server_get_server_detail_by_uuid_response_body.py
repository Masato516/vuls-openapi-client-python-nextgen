...
class ServerGetServerDetailByUUIDResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerGetServerDetailByUUIDResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerGetServerDetailByUUIDResponseBody:
        """Create an instance of ServerGetServerDetailByUUIDResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerGetServerDetailByUUIDResponseBody.parse_obj(obj)

        _obj = ServerGetServerDetailByUUIDResponseBody.parse_obj({
