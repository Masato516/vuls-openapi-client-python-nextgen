...
class RoleGetRoleDetailResponseBody(BaseModel):
    """
    ...
    env_metric_v2s: Optional[conlist(EnvMetricV2ResponseBody)] = Field(None, alias="envMetricV2s", description="envMetricV2s of server role")
    env_metric_v3s: Optional[conlist(EnvMetricV3ResponseBody)] = Field(None, alias="envMetricV3s", description="envMetricV3s of server role")
    ...
    servers: Optional[conlist(ServerChildResponseBody)] = Field(None, description="Servers of server role")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleGetRoleDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleGetRoleDetailResponseBody:
        """Create an instance of RoleGetRoleDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RoleGetRoleDetailResponseBody.parse_obj(obj)

        _obj = RoleGetRoleDetailResponseBody.parse_obj({
