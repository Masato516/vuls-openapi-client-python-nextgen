...
class PkgCpeGetCpeDetailResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PkgCpeGetCpeDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PkgCpeGetCpeDetailResponseBody:
        """Create an instance of PkgCpeGetCpeDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PkgCpeGetCpeDetailResponseBody.parse_obj(obj)

        _obj = PkgCpeGetCpeDetailResponseBody.parse_obj({
