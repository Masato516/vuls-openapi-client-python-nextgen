...
class LockfileAddLockfileResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LockfileAddLockfileResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LockfileAddLockfileResponseBody:
        """Create an instance of LockfileAddLockfileResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LockfileAddLockfileResponseBody.parse_obj(obj)

        _obj = LockfileAddLockfileResponseBody.parse_obj({
