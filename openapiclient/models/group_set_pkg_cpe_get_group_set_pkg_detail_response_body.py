...
class GroupSetPkgCpeGetGroupSetPkgDetailResponseBody(BaseModel):
    ...
    """
    affected_procs: Optional[conlist(AffectedProcResponseBody)] = Field(None, alias="affectedProcs", description="AffectedProcess list of package")
    ...
    tasks: Optional[conlist(ChildTaskResponseBody)] = Field(None, description="updated time of server")
