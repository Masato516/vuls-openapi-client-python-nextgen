...
class GroupSetCveGetGroupSetCveListResponseBody(BaseModel):
    """
    GroupSetCveGetGroupSetCveListResponseBody
    """
    cves: Optional[conlist(GroupSetCveListResponseBody)] = Field(None, description="Group Set Cves list")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetCveGetGroupSetCveListResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetCveGetGroupSetCveListResponseBody:
        """Create an instance of GroupSetCveGetGroupSetCveListResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetCveGetGroupSetCveListResponseBody.parse_obj(obj)

        _obj = GroupSetCveGetGroupSetCveListResponseBody.parse_obj({
            "cves": [GroupSetCveListResponseBody.from_dict(_item) for _item in obj.get("cves")] if obj.get("cves") is not None else None,
