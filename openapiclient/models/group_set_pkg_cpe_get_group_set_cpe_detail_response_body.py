...
class GroupSetPkgCpeGetGroupSetCpeDetailResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetPkgCpeGetGroupSetCpeDetailResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetPkgCpeGetGroupSetCpeDetailResponseBody:
        """Create an instance of GroupSetPkgCpeGetGroupSetCpeDetailResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetPkgCpeGetGroupSetCpeDetailResponseBody.parse_obj(obj)

        _obj = GroupSetPkgCpeGetGroupSetCpeDetailResponseBody.parse_obj({
