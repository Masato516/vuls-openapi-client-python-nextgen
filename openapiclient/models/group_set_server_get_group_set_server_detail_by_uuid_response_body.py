...
class GroupSetServerGetGroupSetServerDetailByUUIDResponseBody(BaseModel):
    ...
    tags: Optional[List[ServerTagResponseBody]] = Field(None, description="tags is list of server tag")
    tasks: Optional[List[ChildTaskResponseBody]] = Field(None, description="tasks of server")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupSetServerGetGroupSetServerDetailByUUIDResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupSetServerGetGroupSetServerDetailByUUIDResponseBody:
        """Create an instance of GroupSetServerGetGroupSetServerDetailByUUIDResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GroupSetServerGetGroupSetServerDetailByUUIDResponseBody.parse_obj(obj)

        _obj = GroupSetServerGetGroupSetServerDetailByUUIDResponseBody.parse_obj({
