...
class TaskListResponseBody(BaseModel):
    ...
    detection_methods: conlist(DetectionMethodResponseBody) = Field(..., alias="detectionMethods", description="DetectionMethods of task")
    detection_tools: conlist(DetectionToolResponseBody) = Field(..., alias="detectionTools", description="DetectionTools of task")
    ...
    listening_ports: conlist(StrictStr) = Field(..., alias="listeningPorts", description="listened ports")
    ...
    pkg_cpe_names: Optional[conlist(StrictStr)] = Field(None, alias="pkgCpeNames", description="Package And CPE Names of task")
    ...
    server_tags: Optional[conlist(StrictStr)] = Field(None, alias="serverTags", description="ServerTags of task")
    ...
    updatable_pkg_cpe_names: Optional[conlist(StrictStr)] = Field(None, alias="updatablePkgCpeNames", description="Updatable Package And CPE Names of task")
