...
class PkgCpeGetPkgCpeListResponseBody(BaseModel):
    """
    PkgCpeGetPkgCpeListResponseBody
    """
    paging: Optional[PagingResponseBody] = None
    pkg_cpes: Optional[conlist(PkgCpeListResponseBody)] = Field(None, alias="pkgCpes", description="PkgCpes list")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PkgCpeGetPkgCpeListResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PkgCpeGetPkgCpeListResponseBody:
        """Create an instance of PkgCpeGetPkgCpeListResponseBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PkgCpeGetPkgCpeListResponseBody.parse_obj(obj)

        _obj = PkgCpeGetPkgCpeListResponseBody.parse_obj({
            "paging": PagingResponseBody.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "pkg_cpes": [PkgCpeListResponseBody.from_dict(_item) for _item in obj.get("pkgCpes")] if obj.get("pkgCpes") is not None else None
        })
        return _obj
