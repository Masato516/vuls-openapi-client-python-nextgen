...
*GroupSetPkgCpeApi* | [**group_set_pkg_cpe_get_group_set_pkg_detail**](docs/GroupSetPkgCpeApi.md#group_set_pkg_cpe_get_group_set_pkg_detail) | **GET** /v1/groupSet/pkgCpe/pkg/{pkgID} | getGroupSetPkgDetail groupSetPkgCpe
